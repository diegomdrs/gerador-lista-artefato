...
module.exports = function (params) {
  ...
  function obterListaSaidaArtefatosUmaTarefa(listaArtefatoSemTarefaMesmoTipo) {
    ...
    return listaArtefatoSemTarefaMesmoTipo.reduce((accum, artefato) => {

      let saida = new SaidaVO()
      const tarefa = artefato.listaTarefa[0]

      saida.listaNumTarefaSaida.push(tarefa.numTarefa)
    ...
    //       artefato.listaTarefa.reduce((accum, tarefa) => {
  ...
  function filtrarArtefatoSemTarefaMesmoTipo(listaArtefato) {
    ...
    for (const artefato of listaArtefato) {
      ...
      if (artefato.listaTarefa.length === 1) {
        ...
        for (const tarefa of listaTarefaUnicoTipoAlteracao) {
