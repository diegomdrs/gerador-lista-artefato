    ...
    describe('', () => {
        ...
        */
        it('teste ordenação dos artefatos dentro da tarefa', async () => {
            ...
            await gitAbc.manipularArquivoComCommit('1111111', 'abc/ResourcearquivoRtu.java', TIPO_MODIFICACAO.ADDED)
            ...
            expectObj(lista[0].listaArtefatoSaida[2], TIPO_MODIFICACAO.ADDED, 1, 'abc/gruntfile-yuiq.js')
            expectObj(lista[0].listaArtefatoSaida[3], TIPO_MODIFICACAO.ADDED, 1, 'abc/arquivo-qux-spec.js')
            expectObj(lista[0].listaArtefatoSaida[4], TIPO_MODIFICACAO.ADDED, 1, 'abc/ResourcearquivoRtu.java')
            expectObj(lista[0].listaArtefatoSaida[5], TIPO_MODIFICACAO.ADDED, 1, 'abc/ArquivoUpeGateway.java')
            expectObj(lista[0].listaArtefatoSaida[6], TIPO_MODIFICACAO.ADDED, 1, 'abc/ArquivoTyuResource.java')
            expectObj(lista[0].listaArtefatoSaida[7], TIPO_MODIFICACAO.ADDED, 1, 'abc/abc/ResourcearquivoRtu.java')
            expectObj(lista[0].listaArtefatoSaida[8], TIPO_MODIFICACAO.ADDED, 1, 'abc/GatewayArquivoAqw.java')
            expectObj(lista[0].listaArtefatoSaida[9], TIPO_MODIFICACAO.ADDED, 1, 'abc/arquivoPty.txt')
