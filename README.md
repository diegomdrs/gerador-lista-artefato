...
Para utilizar a versão Web, tanto na versão para Linux e quanto para Windows, execute o comando `gerador-lista-artefato-qas` com o parâmetro `-s` ou `--server`, como no exemplo abaixo:
